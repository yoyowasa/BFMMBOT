...
def _src_path(kind: str) -> Path:
    ...
    names = {"orders": "order_log.parquet", "trades": "trade_log.parquet", "analytics": "decision_log.parquet"}  # 【関数】analyticsの入力ファイル名を追加
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--kind", choices=["orders", "trades", "analytics"], required=True, help="どのログを出すか")  # 【関数】analyticsも選べるようにする
